...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/23 19:35:19 by frodney           #+#    #+#             */
/*   Updated: 2021/10/23 19:35:47 by frodney          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			get_redir_fd(t_parse_lst *curr_pars, \
			t_deviders **dev_lst, char **str);
...
void		commands_args_fill(t_parse_lst *current_pars, \
			char **command_params, t_env *env_lst);
